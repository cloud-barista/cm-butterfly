...
export function map_init_target(target) {
...
function getMarkerSrc(markerIndex) {
    ...
    switch (remainder) {
        case 0:
            markerSrc = "/assets/images/marker/purple.png"
            break;
        case 1:
            markerSrc = "/assets/images/marker/blue.png"
            break;
        case 2:
            markerSrc = "/assets/images/marker/green.png"
            break;
        case 3:
            markerSrc = "/assets/images/marker/grey.png"
            break;
        case 4:
            markerSrc = "/assets/images/marker/orange.png"
            break;
        case 5:
            markerSrc = "/assets/images/marker/black.png"
            break;
        case 6:
            markerSrc = "/assets/images/marker/red.png"
            break;
        case 7:
            markerSrc = "/assets/images/marker/white.png"
            break;
        case 8:
            markerSrc = "/assets/images/marker/yellow.png"
            break;
        default:
            markerSrc = "/assets/images/marker/black.png"
            break;
...
export function drawMap(map, long, lat, info) {
    ...
    var icon = new ol.style.Style({
        image: new ol.style.Icon({
            // src:'/assets/images/marker/purple.png', // pin Image
...
export function addClickPin(map) {
