...
function runWorkflow(){
    ...
    // cicada api 호출
    try{
        var url = "/migration/workflowmng/workflow/run/" + selectedWorkflowId;
        axios.post(url,
        ).then(result=>{
...
function deleteWorkflow() {
    ...
    var url = "/migration/workflowmng/workflow/del/" + workflowId
...
function getWorkflowList(sort_type) {
    ...
    var url = "/migration/workflowmng/workflow/list";
    axios.get(url, {
        headers: {
            'Content-Type': "application/json"
        }
