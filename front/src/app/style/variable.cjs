...
const spaceoneTailwindConfig = require('@cloudforet-test/mirinae/tailwind.config.cjs');
/**
...
module.exports = {
  ...
  'font-code':
    'Inconsolata, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace',
};
